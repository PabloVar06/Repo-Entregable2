...
export const catalogoJuegos: Juego[] = [
    ...
    { id: 8, nombre: "Cyberpunk 2077", genero: "Accion", plataforma: "PC", fechaLanzamiento: new Date("2020-12-10"), puntaje: 78 },
    { id: 9, nombre: "Concord", genero: "Estrategia", plataforma: "PC", fechaLanzamiento: new Date("2021-03-15"), puntaje: 65 },
    { id: 10, nombre: "Alone in the Dark", genero: "Terror", plataforma: "PC", fechaLanzamiento: new Date("1992-05-01"), puntaje: 55 }
];